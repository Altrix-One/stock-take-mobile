...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchUserDetails() async {
    ...
    if (userDetailsJson != null) {
      ...
      setState(() {
        firstName = userDetails['message']['stock_count_person']['first_name'];
        lastName = userDetails['message']['stock_count_person']['last_name'];
        userEmail = userDetails['message']['stock_count_person']['email'];
      });
    }
  }
