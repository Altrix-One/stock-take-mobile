...
class ApprovalsService {
  ...
  static Future<Map<String, dynamic>> approvalsStats() async {
    try {
      ...
      int teamPendingCount = pendingItems.length; // Items waiting for user to approve
        ...
        if (item is Map) {
          ...
          if (status == 'approved' || status == 'sanctioned') {
            ...
            if (submittedDate != null) {
              ...
              if (submittedDate.isAfter(thisMonthStart) || submittedDate.isAtSameMomentAs(thisMonthStart)) {
                thisMonthApproved++;
              }
            }
            ...
            if (approvedDate != null) {
              final approvedDay = DateTime(approvedDate.year, approvedDate.month, approvedDate.day);
              if (approvedDay == today) {
                approvedToday++; // This will override the submission-based count
              }
              
              if (approvedDate.isAfter(thisMonthStart) || approvedDate.isAtSameMomentAs(thisMonthStart)) {
            ...
            if (approvedDate != null && 
                (approvedDate.isAfter(thisMonthStart) || approvedDate.isAtSameMomentAs(thisMonthStart))) {
              thisMonthRejected++;
            }
